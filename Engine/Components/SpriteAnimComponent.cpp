...
void crae::SpriteAnimComponent::Update()
{
...
bool crae::SpriteAnimComponent::Write(const rapidjson::Value& value) const
{
    return true;
}

bool crae::SpriteAnimComponent::Read(const rapidjson::Value& value)
{
